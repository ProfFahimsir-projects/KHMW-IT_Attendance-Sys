...
export async function POST(request) {
  ...
  try {
    ...
    if (!rollNumber || !studentName || !contactNumber || !fatherContactNumber || !motherContactNumber || !classId) {
      return NextResponse.json(
        { success: false, message: 'All fields (Roll Number, Name, Contact, Father Contact, Mother Contact, Class) are required.' },
        { status: 400 }
      );
    }
